...
export const SUPER_ADMIN_ONBOARDING_LEAD_ROWS: SuperAdminTableRow[] = [
  ...
  },
  {
    ...
    status: "Contacted",
    role: "Use INTELL for my business",
    source: "LinkedIn",
    date: "12 Aug 2026",
...
export const SUPER_ADMIN_COMMUNICATION_ROWS: SuperAdminTableRow[] = [
  {
    ...
    body: "We are opening the INTELL waitlist to installer partners who can help households and SMEs connect compatible inverters, monitor performance, and reduce avoidable downtime.",
    actionLabel: "Review onboarding guide",
    actionUrl: "https://intell.ng/waitlist",
    status: "Scheduled",
    priority: "High",
    date: "Aug 12, 2026",
  },
...
export const SUPER_ADMIN_OVERVIEW_CHARTS = [
  ...
  },
  {
    ...
    icon: Bell,
    input: [
      1200000, 3600000, 6200000, 5800000, 5100000, 4700000, 6300000, 8200000,
      5400000,
    ],
    output: [
      800000, 2200000, 4100000, 3900000, 3200000, 2800000, 4400000, 6800000,
      3600000,
    ],
    inputLabel: "Input",
    outputLabel: "Output",
